...
Do not report security issues in public issues. Use GitHub private vulnerability reporting if enabled for this repository; availability has not been independently verified. Otherwise use the private contact mechanism shown in the repository settings. Do not include credentials, account exports, tokens, or private task data in a report.
