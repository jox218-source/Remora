...
1. Run `npm ci`, `npm run check`, and `npm audit`; require both Windows and Linux CI jobs to pass.
...
6. Tag and publish a GitHub release only after maintainer review. npm packages remain private in this pre-alpha; registry publication needs a separately tested packaging/distribution change.
